...
After deploy, update the API base URL in `extension/src/shared/api.ts` and `extension/src/background/index.ts` to the API Gateway URL, then rebuild the extension.
